...
function new_game()
    ...
    request_event(checkWin, Events.VICTORY_CONDITION_CHECK)
...
function initGame()
    if isDebug() == TRUE then
        ...
        Tutorial.RWM(1)
        dbgTestFunction()
        requestMinuteEvent(startAttack, 1)
        Buildings.AddBuilding(130, 715, 7, Buildings.GUARDTOWERBIG)
        Buildings.AddBuilding(385, 713, 8, Buildings.GUARDTOWERBIG)
...
function startAttack()
    ...
    dbg.stm("attack")
    Settlers.AddSettlers(130, 720, 7, Settlers.SWORDSMAN_01, 20)
    AI.NewSquad(7, AI.CMD_SUICIDE_MISSION )
    Settlers.AddSettlers(390, 725, 8, Settlers.SWORDSMAN_01, 20)
