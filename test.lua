...
function doActionsAfterMinutes()
    ...
    if newMinute() == 1 then
		 if Game.Time() >= 1 then
			 ...
			 Settlers.AddSettlers(530, 695, 2, Settlers.SWORDSMAN_01, 5)
			 AI.NewSquad(2, AI.CMD_SUICIDE_MISSION )
			 Settlers.AddSettlers(670, 680, 2, Settlers.SWORDSMAN_01, 5)
             AI.NewSquad(2, AI.CMD_SUICIDE_MISSION )

			 Settlers.AddSettlers(365, 375, 3, Settlers.SWORDSMAN_01, 5)
			 AI.NewSquad(3, AI.CMD_SUICIDE_MISSION )
			 Settlers.AddSettlers(518, 381, 3, Settlers.SWORDSMAN_01, 5)
             AI.NewSquad(3, AI.CMD_SUICIDE_MISSION )
